    ...
    static class CppGenerator
    {
        ...
        static string ProcessExpression(IExpression expression, ICppScope scope) {
            switch (expression) {
                ...
                case IFunctionDeclaration functionDeclaration: DeclareFunction(functionDeclaration, scope); break;
                case IVariableDeclaration variableDeclaration: DeclareVariable(variableDeclaration, scope); break;
