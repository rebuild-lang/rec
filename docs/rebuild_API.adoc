...
type `LeftParameters`::
  ** single parameter decl or braces required
  ** no special parsers allowed
  ** `.parameters :list(instance.Parameter)`
...
type `Function`::
  ...
  ** `.leftParameters :list(*Parameter)`
  ** `.rightParameters :list(*Parameter)`
...
type `Context`::
  ...
  ** `.declareFunction(leftParams, name, rightParams, results, body, flags = None, context = CurrentContext)`
...
rebuild.context.declareFunction(
  (),                                          # no left parameters
  "fn",                                        # name
  (leftParams : rebuild.decl.LeftParameters,   # right parameters
   flags : rebuild.decl.FunctionFlags,
   name : rebuild.literal.Identifier,
   rightParams : rebuild.decl.RightParameters,
  ...
  rebuild.caller.declareFunction
    leftParams, name, rightParams, result, flags, body
end
----
