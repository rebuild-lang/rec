...
inline constexpr view_t to_string(sign_t sign) {
    switch (sign) {
...
inline constexpr view_t to_string(radix_t radix) {
    switch (radix) {
...
inline std::ostream &operator<<(std::ostream &out, radix_t radix) { return out << to_string(radix); }
